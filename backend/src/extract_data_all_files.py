...
def read_lines_with_fallback(file_path):
    """Try common encodings and return the file lines and full text."""
    ...
    # Fallback with replacement if all encodings fail
...
def extract_metadata_and_sentences(input_file):
    ...
    # Read the input text from the file using the fallback function
    lines, input_text = read_lines_with_fallback(input_file)
